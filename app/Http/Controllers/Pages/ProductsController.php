...
class ProductsController extends Controller
{
  public function index(Request $request)
  {
    ...
    if ($request->has('price') && $request->input('price') != null) {
      ...
      })->select('id', 'name', 'image', 'monitor',  'CPU', 'RAM', 'OS', 'network', 'VGA', 'rate')->orderBy('min_sale_price', $request->input('price'));
    } else {
      $query_products->select('id', 'name', 'image', 'monitor',  'CPU', 'RAM', 'OS', 'network', 'VGA', 'rate')->latest();
    }
  ...
  public function getProduct(Request $request, $id)
  {
    ...
    $product = Product::select('id', 'producer_id', 'name', 'sku_code', 'monitor',  'CPU', 'RAM', 'OS', 'network', 'VGA', 'rate', 'information_details', 'product_introduction')

          ...
          <h2 class="page-header">
            <div style="display: inline-flex; align-items: center;">
              <div style="width: 30px; margin-right: 5px;">
                <img src="{{ asset('images/favicon.png') }}" alt="Lap37 Logo" style="width: 100%; height: auto; object-fit: cover;">
              </div>
              <div style="color: #f33;">Lap37</div>
            </div>
      ...
      <div class="invoice-info">
        <div class="row">
          <div class="col-md-3 col-sm-3 col-xs-3">
            ...
            <address>
              <b>Admin Lap37</b><br>
              Phone: (+84) 989 448 742<br>
              Email: lap37@gmail.com

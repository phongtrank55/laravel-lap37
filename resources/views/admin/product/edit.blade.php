      ...
      <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select class="form-control" name="OS" required>
                  ...
                  <option value="Windows 7" {{ $product->OS == 'Windows 7' ? 'selected' : '' }}>Windows 7</option>
                  <option value="Windows 10" {{ $product->OS == 'Windows 10' ? 'selected' : '' }}>Windows 10</option>
                  <option value="MacOS" {{ $product->OS == 'MacOS' ? 'selected' : '' }}>MacOS</option>
                  <option value="Ubuntu 12" {{ $product->OS == 'Ubuntu 12' ? 'selected' : '' }}>Ubuntu 12</option>
                </select>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="VGA">VGA (GB) <span class="text-red">*</span></label>
                <input type="number" min="1" name="VGA" class="form-control" id="VGA" placeholder="VGA" required autocomplete="off" value="{{ $product->VGA }}">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="network">Mạng <span class="text-red">*</span></label>
                <input type="text" name="network" class="form-control" id="network" placeholder="network" required autocomplete="off" value="{{ $product->network }}">
              </div>
            </div>

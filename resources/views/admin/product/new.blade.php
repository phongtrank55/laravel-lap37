          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="number" min="1" name="VGA" class="form-control" id="VGA" placeholder="VGA" required autocomplete="off">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="network">Mạng <span class="text-red">*</span></label>
                <input type="text" name="network" class="form-control" id="network" placeholder="network" required autocomplete="off">
              </div>
            </div>
